...
<template>
  ...
  <WelcomeItem>
    ...
    <a href="https://www.linkedin.com/in/derek-lui/" target="_blank" rel="noopener">LinkedIn</a> <br>
    <a href="http://github.com/luiderek" target="_blank" rel="noopener">GitHub</a>
  </WelcomeItem>
